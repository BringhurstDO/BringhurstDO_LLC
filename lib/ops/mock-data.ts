...
export const opsDashboardData: OpsDashboardData = {
  ...
  accountRegistry: [
    ...
    },
    {
      ...
      role: "Founder account",
      notes: [
        "Blocked pending Meta trust/Page creation; no live page URL yet",
      ],
      accountType: "Founder profile pending Meta trust",
      publicHandle: "missing",
      status: "blocked_pending_meta_trust",
      statusTone: "blocked",
      purpose: "Blocked founder Facebook row for future manual updates only.",
      sourceBoundary:
        "Track public profile context and aggregate metrics only; no private message content.",
      manualReviewCadence: "Weekly",
      allowedMetrics: ["Posts", "Followers", "Website clicks"],
    ...
    },
    {
      ...
      accountType: "Project page pending Meta trust",
      publicHandle: "missing",
      status: "blocked_pending_meta_trust",
      statusTone: "blocked",
      purpose: "Blocked public company Facebook row for future manual updates only.",
      sourceBoundary: "Track public aggregate metrics only.",
      manualReviewCadence: "Weekly",
      allowedMetrics: ["Posts", "Followers", "Website clicks"],
      forbiddenData: ["Credentials", "Private messages", "Audience exports"],
    ...
    },
    {
      ...
      status: "blocked_pending_meta_trust",
      statusTone: "blocked",
      purpose: "Blocked SyncSOAP Facebook row for future manual updates only.",
      sourceBoundary:
    ...
    },
    {
      ...
      status: "blocked_pending_meta_trust",
      statusTone: "blocked",
      purpose: "Blocked SyncSafety Facebook row for future manual updates only.",
      sourceBoundary: "Track aggregate public metrics only.",
      manualReviewCadence: "Weekly",
      allowedMetrics: ["Posts", "Followers", "Website clicks"],
      forbiddenData: ["Credentials", "Private messages", "Audience exports"],
  ...
  publicationTargets: [
    ...
    },
    {
      ...
      defaultDestinationUrl: bringhurstDoDestination,
      sourceBoundary:
        "Blocked pending Meta trust/Page creation. Do not use for live posting. No Meta API, private messages, contact details, or audience export.",
      approvalRequired: true,
      postingMode: "manual-only",
      spendMode: "manual-approval-required",
    },
    ...
    },
    {
      ...
      defaultDestinationUrl: syncSoapDestination,
      sourceBoundary:
        "Blocked pending Meta trust/Page creation. Do not use for live posting. No Meta API, audience export, private messages, or clinical payloads.",
      approvalRequired: true,
      postingMode: "manual-only",
      spendMode: "manual-approval-required",
    },
