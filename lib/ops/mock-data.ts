  ...
  accountRegistry: [
    {
      ...
      publicHandle: "SyncSOAP public page",
      status: "planned",
      statusTone: "watch",
      purpose: "Manual product positioning and pilot-readiness posts.",
      sourceBoundary:
        "Track account presence and aggregate public metrics only.",
    ...
    },
    {
      ...
      publicHandle: "SyncSOAP public handle",
      status: "planned",
      statusTone: "neutral",
    ...
    },
    {
      ...
      platform: "LinkedIn",
      accountType: "Project company page",
      publicHandle: "SyncSafety public page",
      status: "manual-only",
      statusTone: "good",
    ...
    },
    {
      ...
      platform: "Instagram",
      accountType: "Project account",
      publicHandle: "SyncSafety public handle",
      status: "planned",
      statusTone: "neutral",
    ...
    },
    {
      ...
      kind: "founder",
      platform: "LinkedIn",
      accountType: "Founder account",
      publicHandle: "Founder public profile",
      status: "manual-only",
      statusTone: "watch",
      purpose: "Manual founder-led updates after approval.",
      sourceBoundary:
        "Track aggregate public metrics only; do not store inbox content.",
      manualReviewCadence: "Weekly",
      allowedMetrics: ["Posts", "Followers", "Conversations"],
    ...
    },
    {
      ...
      platform: "X",
      accountType: "Founder account",
      publicHandle: "Founder public handle",
      status: "planned",
      statusTone: "neutral",
  ...
  socialMetricPlaceholders: [
    {
      ...
      accountIds: ["account-syncsafety-instagram"],
      status: "placeholder",
      sourceBoundary:
    ...
    },
    {
      id: "placeholder-x",
      platform: "X",
      accountIds: ["account-syncsoap-x", "account-founder-x"],
      status: "placeholder",
      sourceBoundary:
  ...
  publicationTargets: [
    {
      ...
      sourceBoundary:
        "Manual public post target. No posting API, audience export, or inbox data.",
      approvalRequired: true,
    ...
    },
    {
      ...
      defaultDestinationUrl: syncSoapDestination,
      sourceBoundary:
        "Manual public thread target. No posting API, audience export, or private messages.",
      approvalRequired: true,
      postingMode: "manual-only",
      spendMode: "manual-approval-required",
    },
    ...
    },
    {
      ...
      accountName: "Founder LinkedIn",
      platform: "LinkedIn",
      publicHandle: "Founder public profile",
      audience: "investors",
      defaultDestinationUrl: bringhurstDoDestination,
      sourceBoundary:
        "Manual founder post target. No private messages or contact details.",
      approvalRequired: true,
      postingMode: "manual-only",
      spendMode: "manual-approval-required",
    },
