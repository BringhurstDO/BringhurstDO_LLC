...
// Signed OAuth state for CSRF protection. The state value is stored both in a
// short-lived httpOnly cookie and the LinkedIn `state` query param; the callback
// requires both to match and the signature to verify.

export const LINKEDIN_OAUTH_STATE_COOKIE = "ops_li_oauth_state";
export const LINKEDIN_OAUTH_ACCOUNT_COOKIE = "ops_li_oauth_account";
